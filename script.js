...
function showTrophy(el){
	document.getElementById('center').src = "lombardi_trophy.png";
	document.getElementById('rams1').src = "lombardi_trophy.png";
	document.getElementById('pats1').src = "lombardi_trophy.png";
}
